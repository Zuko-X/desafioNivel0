...
//     ganador =  "El encuentro a sido un empate.";
// }
...
if (contadorPuntosJug1 > contadorPuntosJug2) {
    ganador = jugadorUno.nombre + " es el ganador del encuentro.";
}
else if (contadorPuntosJug2 > contadorPuntosJug1) {
    ganador = jugadorDos.nombre + " es el ganador del encuentro.";
}
else {
    ganador = "El el encuentro a terminado en empate."
}
